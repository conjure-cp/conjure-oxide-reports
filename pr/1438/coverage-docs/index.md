...
**conjure-cp-cli:** 0% with examples, 40% documented -- 0/44/109
**conjure-cp-core:** 4% with examples, 50% documented -- 22/299/604
...
**tree-morph:** 10% with examples, 100% documented -- 7/71/71
...
Commit: [268ed997b6a5e1ca838bb46463309faa82a42e42](https://github.com/Arnav-Bista/conjure-oxide/commit/268ed997b6a5e1ca838bb46463309faa82a42e42)
...
| crates/conjure-cp-cli/src/test_solve.rs | ❌ 25% *(1/4)* | ❌ 0% *(0/4)* |
| crates/conjure-cp-cli/src/utils/testing.rs | ❌ 31% *(4/13)* | ❌ 0% *(0/13)* |
| crates/conjure-cp-cli/src/solve.rs | ❌ 39% *(7/18)* | ❌ 0% *(0/18)* |
| crates/conjure-cp-cli/src/find_conjure.rs | ❌ 50% *(1/2)* | ❌ 0% *(0/2)* |
| crates/conjure-cp-cli/src/cli.rs | ❌ 53% *(25/47)* | ❌ 0% *(0/47)* |
...
| crates/conjure-cp-core/src/ast/metadata.rs | ❌ 0% *(0/5)* | ❌ 0% *(0/5)* |
...
| crates/conjure-cp-core/src/context.rs | ❌ 0% *(0/11)* | ❌ 0% *(0/11)* |
...
| crates/conjure-cp-core/src/settings.rs | ❌ 2% *(1/46)* | ❌ 0% *(0/46)* |
...
| crates/conjure-cp-core/src/ast/expressions.rs | ✅ 93% *(83/89)* | ❌ 0% *(0/89)* |
...
| crates/conjure-cp-core/src/rule_engine/rewrite_morph.rs | ✅ 100% *(3/3)* | ❌ 0% *(0/3)* |
...
| crates/conjure-cp-essence-parser/src/diagnostics/source_map.rs | ❌ 0% *(0/19)* | ❌ 0% *(0/19)* |
...
| crates/conjure-cp-essence-parser/src/parser/syntax_errors.rs | ❌ 0% *(0/2)* | ❌ 0% *(0/2)* |
...
| crates/conjure-cp-essence-parser/src/errors.rs | ❌ 21% *(5/24)* | ❌ 0% *(0/24)* |
...
| File | Percentage Documented | Percentage with examples |
|----|----|----|
| crates/tree-morph/src/cache.rs | ✅ 100% *(15/15)* | ❌ 0% *(0/15)* |
| crates/tree-morph/src/commands.rs | ✅ 100% *(5/5)* | ❌ 20% *(1/5)* |
| crates/tree-morph/src/engine.rs | ✅ 100% *(5/5)* | ❌ 20% *(1/5)* |
| crates/tree-morph/src/engine_builder.rs | ✅ 100% *(19/19)* | ❌ 0% *(0/19)* |
...
| crates/tree-morph/src/rule.rs | ✅ 100% *(16/16)* | ❌ 25% *(4/16)* |
