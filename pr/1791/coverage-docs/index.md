...
**conjure-cp-core:** 3% with examples, 48% documented -- 23/332/686
...
**minion-sys:** 2% with examples, 30% documented -- 2/38/126
...
PR: [#1791](https://github.com/conjure-cp/conjure-oxide/pull/1791)
Commit: [9c9d973b0e168e54ddfe18fe079949742005b1df](https://github.com/conjure-cp/conjure-oxide/commit/9c9d973b0e168e54ddfe18fe079949742005b1df)
...
| crates/conjure-cp-core/src/ast/domains/attrs.rs | ❌ 0% *(0/34)* | ❌ 0% *(0/34)* |
| crates/conjure-cp-core/src/ast/domains/range.rs | ❌ 0% *(0/6)* | ❌ 0% *(0/6)* |
| crates/conjure-cp-core/src/ast/enumerated.rs | ❌ 0% *(0/14)* | ❌ 0% *(0/14)* |
...
| crates/conjure-cp-core/src/ast/types.rs | ❌ 13% *(2/15)* | ❌ 0% *(0/15)* |
| crates/conjure-cp-core/src/ast/domains/error.rs | ❌ 14% *(1/7)* | ❌ 0% *(0/7)* |
| crates/conjure-cp-core/src/ast/literals.rs | ❌ 15% *(2/13)* | ❌ 0% *(0/13)* |
...
| crates/conjure-cp-core/src/ast/domains/unresolved.rs | ❌ 45% *(9/20)* | ❌ 0% *(0/20)* |
...
| crates/conjure-cp-core/src/ast/domains/ground.rs | ❌ 75% *(12/16)* | ❌ 0% *(0/16)* |
...
| crates/conjure-cp-core/src/ast/declaration.rs | ❌ 81% *(42/52)* | ❌ 23% *(12/52)* |
...
| crates/conjure-cp-core/src/ast/expressions.rs | ✅ 94% *(90/96)* | ❌ 0% *(0/96)* |
...
| crates/minion-sys/src/run.rs | ✅ 100% *(5/5)* | ❌ 20% *(1/5)* |
