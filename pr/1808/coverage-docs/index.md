...
**conjure-cp-core:** 3% with examples, 49% documented -- 23/346/706
**conjure-cp-enum-compatibility-macro:** 33% with examples, 100% documented -- 1/3/3
**conjure-cp-essence-macros:** 0% with examples, 67% documented -- 0/2/3
**conjure-cp-essence-parser:** 0% with examples, 16% documented -- 0/29/186
...
Commit: [0c7a4801472905e0a60f3fa76b3e95c52f6d651b](https://github.com/matteraggi/conjure-oxide/commit/0c7a4801472905e0a60f3fa76b3e95c52f6d651b)
...
| crates/conjure-cp-core/src/ast/domains/attrs.rs | ❌ 0% *(0/41)* | ❌ 0% *(0/41)* |
...
| crates/conjure-cp-core/src/solver/adaptors/ortools-cpsat/mod.rs | ❌ 0% *(0/1)* | ❌ 0% *(0/1)* |
| crates/conjure-cp-core/src/solver/adaptors/ortools-cpsat/stub.rs | ❌ 0% *(0/2)* | ❌ 0% *(0/2)* |
...
| crates/conjure-cp-core/src/settings.rs | ❌ 4% *(2/55)* | ❌ 0% *(0/55)* |
...
| crates/conjure-cp-core/src/ast/domains/error.rs | ❌ 14% *(1/7)* | ❌ 0% *(0/7)* |
...
| crates/conjure-cp-core/src/ast/domains/unresolved.rs | ❌ 40% *(8/20)* | ❌ 0% *(0/20)* |
...
| crates/conjure-cp-core/src/ast/domains/ground.rs | ❌ 76% *(13/17)* | ❌ 0% *(0/17)* |
...
| crates/conjure-cp-core/src/ast/expressions.rs | ✅ 94% *(97/103)* | ❌ 0% *(0/103)* |
...
| File | Percentage Documented | Percentage with examples |
|----|----|----|
| crates/conjure-cp-essence-macros/src/lib.rs | ❌ 67% *(2/3)* | ❌ 0% *(0/3)* |
